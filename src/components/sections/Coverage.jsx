...
const Coverage = () => {
  // Area data with realistic Setapak dispatch times and surcharge warnings
  const areasData = [
    {
      name: "Kuala Lumpur",
      arrival: "30 - 45 Mins",
      popular: "Chemical Wash",
      status: "Fast Dispatch",
    },
    {
      name: "Petaling Jaya",
      arrival: "45 - 60 Mins",
      popular: "General Service",
      status: "Active Daily",
    },
    {
      name: "Subang Jaya",
      arrival: "60 - 90 Mins",
      popular: "Diagnosis & Repair",
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-stretch gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          ...
          <p className="text-lg text-base-dark/70 mb-10 leading-relaxed max-w-xl">
            Select your location below to see our typical response times and
            local service details for your area.
          </p>
          ...
          <div className="bg-slate-50 p-6 md:p-8 rounded-[2rem] border border-slate-200 shadow-xl flex-1 flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-4 mb-8">
              {areasData.map((area, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-2 h-2 md:w-2.5 md:h-2.5 rounded-full transition-colors duration-300 flex-shrink-0 ${isActive ? "bg-brand shadow-[0_0_8px_rgba(0,70,255,0.4)]" : "bg-slate-300"}`}
                    ></div>
                    <span
                      className={`text-sm md:text-lg font-bold ${isActive ? "text-brand" : "text-base-dark"}`}
                    >
                      {area.name}
                    </span>
                  </button>
            ...
            <div className="pt-6 border-t border-slate-200 mt-auto">
              <p className="text-sm text-base-dark/60 font-semibold leading-relaxed">
                <span className="text-accent font-black mr-2 uppercase text-xs px-2 py-1 bg-accent/10 rounded">
                  Note
                </span>
                Transportation and toll charges apply for Subang Jaya and Shah
                Alam. Outside these areas? Contact us on WhatsApp to check
                availability.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div
            key={activeArea.name}
            className="grid grid-cols-2 gap-4 md:gap-6 flex-1 animate-fade-in-up"
          >
            {/* Stat 1: Arrival Time */}
            <div className="bg-white p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-center text-center items-center">
              <p className="text-[10px] md:text-xs font-bold text-base-dark/50 uppercase tracking-widest mb-2 md:mb-3">
                Est. Arrival Time
              </p>
            ...
            <div className="bg-white p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-center text-center items-center">
              ...
              <p className="text-lg md:text-2xl font-black text-base-dark leading-tight">
                {activeArea.status}
              </p>
            </div>
            ...
            <div className="bg-white p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-center text-center items-center">
              ...
              <p className="text-base md:text-xl font-bold text-base-dark leading-tight">
                {activeArea.popular}
              </p>
            </div>
            ...
            <div className="bg-white p-4 md:p-6 rounded-2xl md:rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-center bg-gradient-to-br from-brand/5 to-transparent text-center items-center">
              ...
              <div className="flex items-end justify-center gap-1 md:gap-2">
                <p className="text-2xl md:text-4xl font-black text-accent">
                  5.0
                </p>
                <div className="flex text-accent text-sm md:text-xl pb-1 mb-0.5">
                  ★★★★★
                </div>
              </div>
            </div>
